    ...
    <div className="grid max-w-md grid-cols-1 gap-6 mx-auto mt-8 lg:mt-16 lg:grid-cols-3 lg:max-w-full">
      <div className="overflow-hidden bg-white rounded shadow">
        <div className="p-5">
          <div className="relative">
            <a href="#" title="" className="block aspect-w-4 aspect-h-2">
              <img className="object-cover w-full h-full" src="https://i0.wp.com/humanityfirsthome.org/wp-content/uploads/2023/01/CD94FF42-A604-4A71-86C4-5706DEBC2849.jpg" alt="" />
            </a>
      ...
      <div className="overflow-hidden bg-white rounded shadow">
        <div className="p-5">
          <div className="relative">
            ...
            <img className="object-cover w-full h-full" src="https://i0.wp.com/humanityfirsthome.org/wp-content/uploads/2023/01/FA725E45-27A6-40A2-B10A-AF3D36F1CA30.jpg" alt="" />
            
            </a>
            <div className="absolute top-4 left-4">
              <span className="px-4 py-2 text-xs font-semibold tracking-widest text-gray-900 uppercase bg-white rounded-full"> upcoming </span>
            </div>
          </div>
          <span className="block mt-6 text-sm font-semibold tracking-widest text-gray-500 uppercase"> April 04, 2023 </span>
          <p className="mt-5 text-2xl font-semibold">
            <a href="#" title="" className="text-black"> Advancement of Nutrition Needs for the Underprivileged. </a>
          </p>
      ...
      <div className="overflow-hidden bg-white rounded shadow">
        <div className="p-5">
          <div className="relative">
            <a href="#" title="" className="block aspect-w-4 aspect-h-3">
            <img className="object-cover w-full h-full" src="https://i0.wp.com/humanityfirsthome.org/wp-content/uploads/2023/01/IMG_5727_edited-scaled.jpeg" alt="" />
             
            </a>
            <div className="absolute top-4 left-4">
              <span className="px-4 py-2 text-xs font-semibold tracking-widest text-gray-900 uppercase bg-white rounded-full"> completed </span>
            </div>
          </div>
          <span className="block mt-6 text-sm font-semibold tracking-widest text-gray-500 uppercase"> May 12, 2022 </span>
          <p className="mt-5 text-2xl font-semibold">
